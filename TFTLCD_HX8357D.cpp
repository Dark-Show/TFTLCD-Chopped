...
// OR BREAKOUT BOARD USAGE.  SEE RELEVANT COMMENTS IN TFTLCD_HX8357D.h
...
TFTLCD_HX8357D::TFTLCD_HX8357D(uint8_t cs, uint8_t cd, uint8_t wr, uint8_t rd,
                                 uint8_t reset)
...
TFTLCD_HX8357D::TFTLCD_HX8357D(void) : Adafruit_GFX(TFTWIDTH, TFTHEIGHT) {
  init();
}

// Initialization common to both shield & breakout configs
void TFTLCD_HX8357D::init(void) {
...
void TFTLCD_HX8357D::reset(void) {
...
void TFTLCD_HX8357D::setAddrWindow(int x1, int y1, int x2, int y2) {
  uint32_t t;
  CS_ACTIVE;
  t = x1;
  t <<= 16;
...
void TFTLCD_HX8357D::setLR(void) {
  CS_ACTIVE;
...
void TFTLCD_HX8357D::flood(uint16_t color, uint32_t len) {
  uint16_t blocks;
...
void TFTLCD_HX8357D::drawFastHLine(int16_t x, int16_t y, int16_t length,
                                    uint16_t color) {
  int16_t x2;
...
void TFTLCD_HX8357D::drawFastVLine(int16_t x, int16_t y, int16_t length,
                                    uint16_t color) {
  int16_t y2;
...
void TFTLCD_HX8357D::fillRect(int16_t x1, int16_t y1, int16_t w, int16_t h,
                               uint16_t fillcolor) {
  int16_t x2, y2;
...
void TFTLCD_HX8357D::fillScreen(uint16_t color) {
...
void TFTLCD_HX8357D::drawPixel(int16_t x, int16_t y, uint16_t color) {
...
void TFTLCD_HX8357D::pushColors(uint16_t *data, uint8_t len, boolean first) {
  uint16_t color;
  uint8_t hi, lo;
  CS_ACTIVE;
...
void TFTLCD_HX8357D::setRotation(uint8_t x) {
...
uint16_t TFTLCD_HX8357D::readPixel(int16_t x, int16_t y) {
    return 0;
}

// Ditto with the read/write port directions, as above.
uint16_t TFTLCD_HX8357D::readID(void) {
  uint16_t id;
...
uint32_t TFTLCD_HX8357D::readReg(uint8_t r) {
  uint32_t id;
  uint8_t x;
...
uint16_t TFTLCD_HX8357D::color565(uint8_t r, uint8_t g, uint8_t b) {
...
#ifndef write8
void TFTLCD_HX8357D::write8(uint8_t value) { write8inline(value); }
#endif

#ifdef read8isFunctionalized
uint8_t TFTLCD_HX8357D::read8fn(void) {
  uint8_t result;
  read8inline(result);
  return result;
}
...
#ifndef setWriteDir
void TFTLCD_HX8357D::setWriteDir(void) { setWriteDirInline(); }
#endif

#ifndef setReadDir
void TFTLCD_HX8357D::setReadDir(void) { setReadDirInline(); }
#endif

#ifndef writeRegister8
void TFTLCD_HX8357D::writeRegister8(uint8_t a, uint8_t d) {
  writeRegister8inline(a, d);
}
#endif

#ifndef writeRegister16
void TFTLCD_HX8357D::writeRegister16(uint16_t a, uint16_t d) {
  writeRegister16inline(a, d);
}
#endif

#ifndef writeRegisterPair
void TFTLCD_HX8357D::writeRegisterPair(uint8_t aH, uint8_t aL, uint16_t d) {
  writeRegisterPairInline(aH, aL, d);
}
#endif

void TFTLCD_HX8357D::writeRegister24(uint8_t r, uint32_t d) {
  CS_ACTIVE;
  CD_COMMAND;
  write8(r);
  CD_DATA;
...
void TFTLCD_HX8357D::writeRegister32(uint8_t r, uint32_t d) {
  CS_ACTIVE;
  CD_COMMAND;
  write8(r);
  CD_DATA;
