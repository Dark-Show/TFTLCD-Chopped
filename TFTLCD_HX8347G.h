...
#ifndef _TFTLCD_HX8347G_H_
#define _TFTLCD_HX8347G_H_
...
class TFTLCD_HX8347G : public Adafruit_GFX {

public:
  TFTLCD_HX8347G(uint8_t cs, uint8_t cd, uint8_t wr, uint8_t rd, uint8_t rst);
  TFTLCD_HX8347G(void);
